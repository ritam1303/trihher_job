...
public class Test1
{
    ...
    public void testSetUp(String browser, String version, String platform, String resolution) throws Exception
    {
        ...
        capabilities.setCapability("webDriverMode",true);
    ...
    public void test1_element_addition_1() throws InterruptedException
    {
        ...
        System.out.println("Adding alert confirmation to the test case");

        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("var result = confirm('Do you want to allow this action?'); if (result) { alert('You clicked Allow!'); } else { alert('You clicked Disable!'); }");
        Alert alert = driver.switchTo().alert();
        Thread.sleep(20000);
        addText.sendKeys("Adding a new item " + 1 + Keys.ENTER);
        //alert.accept();
